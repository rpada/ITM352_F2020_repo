/* 
Alyssa Mencel's Assignment 3 server 
made with previous components from assignment 1 and assignment 2 
*/
    ...
    */
    ...
    var transporter = nodemailer.createTransport({ //create the transporter variable
        ...
        auth: {
            ...
            pass: 'fakeluv498'
          } //notezon itmvm webserver have to use the mail from hawaii.edu
    });
    var mailOptions = {
        from: 'riannepitm352@gmail.com', //sends the invoice from my email, alyssamencel@gmail.com
        to: theEmail, //sends the email to cookie from the account that was logged in
        subject: 'Invoice',
